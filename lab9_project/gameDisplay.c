...
void hangmanDisplay_init()
{
    ...
    for(uint16_t i = 0; i < 13; i++){
        display_drawLine(CONFIG_BOX_KEYBOARD_X_0 + CONFIG_LINE_VERTICLE_LETTER_SPACE * (i+1),CONFIG_BOX_KEYBOARD_Y_0,CONFIG_BOX_KEYBOARD_X_0 + CONFIG_LINE_VERTICLE_LETTER_SPACE * (i+1),CONFIG_LINE_KEYBOARD_Y, CONFIG_BOX_COLOR); // keyboard cut
